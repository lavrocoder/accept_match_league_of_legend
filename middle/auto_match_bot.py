...
from backend.models import Champions, Champion
from backend.models.db_models import Preset, Setting
from backend.services.updater import ProjectUpdater
from backend.utils import get_lobby, load_champions, get_champions_for_role_by_mastery, get_current_queue, \
...
class AutoMatchBot:
    def __init__(self, ddragon_data):
        ...
        self.champions_for_role: Champions | None = None
